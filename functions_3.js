    ...
    var canvas = d3.select("#canvas")
              ...
              var all_spring_constants=[
               ...
               for (var i=0;i<num_of_candidates;i++){       
                ...
                draw_candidates(i, all_spring_constants[i], canvas, colors, main_x, main_y, main_r, false)
...
function draw_candidates(candidate_id, spring_constants, canvas, colors, main_x, main_y, main_r, redraw){
                ...
                document.onmousemove = function(event){
  	            ...
  	            mouse_y = event.pageY;
                    ...
                    if(target_name!=""){
                         ...
                         for (var i=0;i<num_of_candidates;i++){
                            draw_candidates(i, all_spring_constants[i], canvas, colors, main_x, main_y, main_r, true)
                         }    
